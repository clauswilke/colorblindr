...
For more information on Color Universal Design see http://jfly.iam.u-tokyo.ac.jp/color/
...
Applying simulations to images accurately conveys whether color coding schemes will be distiguishable with the most common forms of color vision deficiency.  
```{r}
library(magick)
